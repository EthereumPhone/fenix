...
public class EthENSResolver {
    ...
    public EthENSResolver(Web3j web3j, long syncThreshold, int addressLength) {
        this.web3j = web3j;
    ...
    public EthENSResolver(Web3j web3j, long syncThreshold) {
        this(web3j, syncThreshold, Keys.ADDRESS_LENGTH_IN_HEX);
    }

    public EthENSResolver(Web3j web3j) {
